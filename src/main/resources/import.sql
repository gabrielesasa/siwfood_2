...
insert into artist (id, name, surname, year) values(nextval('artist_seq'), 'Lucio', 'Dalla', 1943);
insert into artist (id, name, surname, year) values(nextval('artist_seq'), 'Vincent', 'Van Gogh', 1853);
